...
class Game
  ...
  # Suggested improvement: move the hardcoded deck to a `hardcoded_deck.txt` file and
  # read it the same way as above
  def play_with_hardcoded_deck
    ...
    # I was wondering why I didn't get this question, and realized @card_5 was declared twice
    @card_6 = Card.new('What is the best IDE?', 'Vim', :STEM)
    @card_7 = Card.new('Initials of the creator of Rails', 'DHH', :STEM)
    @card_8 = Card.new('Author of POODR and Ruby Legend', 'Sandi Metz', :STEM)
    @card_9 = Card.new('What is the abbreviation for Model, View, Controller?', 'MVC', :STEM)
    @card_10 = Card.new('Name of the opensource app store for terminal?', 'Homebrew', :STEM)
